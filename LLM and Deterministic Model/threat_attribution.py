...
# def find_candidate_actors(llm_record: Dict, mitre_actors: List[Dict], technique_threshold: float = 0.2):
...
# def process_folder(llm_folder: str, mitre_actors: List[Dict], csv_output: str):
#     rows = []
...
#         path = os.path.join(llm_folder, filename)
#         llm_record = load_json(path)
...
#     parser.add_argument("--llm-folder", required=True)
...
#     process_folder(args.llm_folder, mitre_actors, args.output)
